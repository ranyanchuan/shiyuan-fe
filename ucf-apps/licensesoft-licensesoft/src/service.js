...
//定义接口地址
const URL = {
    "GET_LIST": `${GROBAL_HTTP_CTX}` + `/licensesoft/licensesoft/list`,
    "GET_ADD": `${GROBAL_HTTP_CTX}` + `/licensesoft/licensesoft/saveMultiple`,
    "GET_UPDATE": `${GROBAL_HTTP_CTX}` + `/licensesoft/licensesoft/updateMultiple`,
    "GET_DELETE": `${GROBAL_HTTP_CTX}` + `/licensesoft/licensesoft/deleteBatch`,
    "GET_TOEXPORTEXCEL": `${GROBAL_HTTP_CTX}` + `/licensesoft/licensesoft/toExportExcel`,
    //行过滤
    "GET_LIST_BY_COL": `${GROBAL_HTTP_CTX}` + `/licensesoft/licensesoft/distinct`,
}
